from globals import unlocks_auto_unlock, num_item_threshold, water_threshold, num_weird_sub_threshold, entities_soil, entities_water_allowed, entities_fertilizer_allowed
